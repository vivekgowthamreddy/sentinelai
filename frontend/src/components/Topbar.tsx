...
const Topbar = ({
    ...
    return (
        <div className="border-b border-(--color-border) bg-(--color-bg-subtle)/80 backdrop-blur-md px-6 sm:px-8 py-5 pb-6 flex items-center sticky top-0 z-40 transition-all duration-300">
